...
(function (window, undefined) {
            ...
            function ready() {
                ...
                K(doc).keydown(function(e) {
                    if (e.ctrlKey && e.which==13) {
                        layui.$('body button[lay-filter="form-submit"]').click();
                    }
                });
            }
            if (isDocumentDomain) {
    ...
    function _bindNewlineEvent() {
        ...
        K(doc).keyup(function (e) {
            ...
            /* 在 Chrome 上添加标题之后换行 JS 报错
            https://github.com/kindsoft/kindeditor/commit/6e2d34e740e76c597cc56f99706d5dc706ed6e6a
